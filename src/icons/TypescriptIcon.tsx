...
type TypescriptIconProps = SVGAttributes<SVGElement> & {}

const TypescriptIcon: FC<TypescriptIconProps> = (props) => {
  const { width = 48, height = width ? width : 48, viewBox = '0 0 512 512', ...otherProps } = props
  return (
